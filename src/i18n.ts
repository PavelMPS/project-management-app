      ...
      ru: {
        translation: {
          ...
          login: {
            ...
            enterBtn: 'Войти',
            errors: {
              minLogin: 'Ваш логин должен быть менее 3 символов',
              maxLogin: 'Ваш логин должен быть более 15 символов',
              minPassword: 'Ваш пароль должен быть менее 3 символов',
              maxPassword: 'Ваш пароль должен быть более 15 символов',
            },
            placeholder: {
              login: 'Введите логин',
